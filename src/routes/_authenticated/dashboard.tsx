...
function DashboardPage() {
  ...
  const cards = [
    { label: "Total Postingan", value: stats?.total ?? 0, icon: FileText, color: "var(--neon-cyan)" },
    { label: "Terkirim", value: stats?.posted ?? 0, icon: CheckCircle2, color: "var(--success)" },
    { label: "Terjadwal", value: stats?.scheduled ?? 0, icon: CalendarClock, color: "var(--neon-violet)" },
        ...
        <div className="panel rounded-2xl p-5 lg:col-span-1">
          ...
          <div className="mt-3 space-y-2 text-sm">
            <div className="flex justify-between">
              ...
              <span
                className={
                  stats?.channelConnected ? "font-semibold text-[var(--success)]" : "text-destructive"
                }
              >
